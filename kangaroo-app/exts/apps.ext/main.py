...
class Plugin(QWidget):
    ...
    def search_app(self):
        for k, v in apps.items():
            if ((self.query and k) and 
                ...
                item = self.pkg.add_item_widget(self.ui.list_widget, frame, v["icon"], k, v['comment'], icon_size=25)
    ...
    def set_apps(self):
        for i in list(dict.fromkeys(glob("/usr/share/applications/*.desktop"))):
